...
# Creates a OBR segment for the HL7 message
...
def create_obr(patient_info, placer_order_num, filler_order_id, hl7):
    try:
        ...
        hl7.obr.obr_2 = (
            placer_order_num  # Some dummy placer order ID up to 75 characters
        )
        hl7.obr.obr_3 = (
            filler_order_id  # Some dummy filler order ID up to 75 characters
        )
        ...
        # Ordering Provider 2 component 1 component
        # 1 lab.Resultp_extra.doc_ordering
        # Default 'WACON'2 component
        # 1 lab.Request.doctor Default 'TEST'
        hl7.obr.obr_16 = "WACON^TEST"
        # Diagnostic Service ID  2 components 1^2 component 2 lab.Request.lab
        hl7.obr.obr_24 = "BI^UHC"
        # Quantity/Timing 6 component s 6 components1 component
        # 4 lab.Request.date_service,lab.Request.time_service
        # 2 component
        # 4 lab.Request.date_coln,lab.Request.time_coln
        # 3 component 6 lab.Request.priority_coln
