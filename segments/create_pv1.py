...
# Creates a PV1 segment for the HL7 message requires
#  a patient_info object and the hl7 message
def create_pv1(patient_info, hl7):
    try:
        ...
        hl7.pv1.pv1_8 = "^ANAESTHETICS CONS^^^^^^L"
        # Set Patient Type to Ambulatory
